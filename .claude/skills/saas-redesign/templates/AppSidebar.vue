<!--
  TEMPLATE — client/src/components/AppSidebar.vue
  Reference for vue-expert. Plain Composition API to match the codebase.
  Icons are simple hand-drawn SVGs (correct + neutral); swap for Heroicons v2
  outline later if desired — keep viewBox="0 0 24 24", fill="none", stroke="currentColor".
-->
<template>
